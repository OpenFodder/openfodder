if(NOT "mpeg-intro" IN_LIST FEATURES)
    message(FATAL_ERROR "This OpenFodder overlay supports only the Windows mpeg-intro feature.")
endif()
...
if(VCPKG_DETECTED_MSVC)
    ...
    # FFmpeg otherwise defaults its host compiler to GCC, which MSVC builds do not provide.
    string(APPEND OPTIONS " --host-cc=cl.exe")
...
if("mpeg-intro" IN_LIST FEATURES)
    # OpenFodder's Intro.mpg is an MPEG program stream containing MPEG-1 video
    # and MP2 audio. Apply this last so platform defaults cannot re-enable
    # hardware backends, network protocols, or unrelated codecs.
    set(_intro_features core mpeg-intro avcodec avformat swresample swscale)
    foreach(_feature IN LISTS FEATURES)
        if(NOT _feature IN_LIST _intro_features)
            message(FATAL_ERROR "mpeg-intro cannot be combined with FFmpeg feature '${_feature}'")
        endif()
    endforeach()
    string(APPEND OPTIONS
        " --disable-everything --disable-network --disable-programs"
        " --disable-avdevice --disable-avfilter"
        " --disable-d3d11va --disable-d3d12va --disable-dxva2"
        " --disable-mediafoundation --disable-schannel --disable-v4l2-m2m"
        " --enable-decoder=mpeg1video,mp2"
        " --enable-parser=mpegvideo,mpegaudio"
        # MPEG-PS probes its video packets through the raw MPEG video demuxer.
        " --enable-demuxer=mpegps,mpegvideo --enable-protocol=file")
endif()
