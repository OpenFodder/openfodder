...
void cFodder::sub_24173( sSprite_0* pSprite ) {
	sSprite_0* Data2C = 0;
	...
	int16 ax = sub_24C47( pSprite, Data2C );
	goto loc_24234;
...
int16 cFodder::sub_24C47( sSprite_0* pSprite, sSprite_0* Data2C ) {
