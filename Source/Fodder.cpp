...
int16 cFodder::sub_2D91E( sSprite_0* pSprite ) {
	...
	int32 Data0 = Data24[pSprite->field_40];

	if (Data0 >= 0) {
		pSprite->field_26 = Data0;
		pSprite->field_28 = Data0 >> 16;
		pSprite->field_40++;
		pSprite->field_42 = -1;
		return 0;
