...
loc_230B0:;
	...
	Data0 = 0;
	Data0 >>= 3;
	pSprite->field_1A = (int32*) (Data0 | (pSprite->field_36 << 16));
	return;
...
int16 cFodder::sub_23444( sSprite_0* pSprite ) {
	if (!pSprite->field_5C)
		return -1;
...
int16 cFodder::sub_2449E( sSprite_0* pSprite ) {
	...
	Sound_Voc_Play( pSprite, 0x23B, 0x0F );
	if (!pSprite->field_5C)
		return -1;
